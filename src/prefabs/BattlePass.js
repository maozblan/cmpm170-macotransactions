...
class BattlePass{
    constructor(scene, x, y, scale=1, num_options) {
        ...
        this.b2 = new Button(scene, (() => {this.buy(25, 27)}), this, `Option 2: 25% - $27`, x - 110, this.height / 2 + 120, 0) //180
        this.b3 = new Button(scene, (() => {this.buy(15, 20)}), this, `Option 3: 15% - $20`, x - 110, this.height / 2 + 175, 0) //250
        this.b4 = new Button(scene, (() => {this.buy(10, 15)}), this, `Option 4: 10% - $15`, x - 110, this.height / 2 + 230, 0) //320
